#ifndef OPTPARSE_H_1356438134_93
#define OPTPARSE_H_1356438134_93
/**
 * File: optparse.h
 * Description: 
 *
 ...
 * 
 * Date: 2012-12-25 20:22:14.934446
...
namespace optparse {
	...
	class OptionValue {
	public:
		OptionValue() : str(), valid(false) {}
		OptionValue(const std::string& v) : str(v), valid(true) {}
	...
	public:
		...
		OptionValue get(const std::string& d) const { return (is_set(d)) ? OptionValue((*this)[d]) : OptionValue(); }
	...
	public:
		...
		OptionArgs& parse_args(int argc, char const* const* argv);
		OptionArgs& parse_args(const std::vector<std::string>& args);
		template<typename InputIterator>
		OptionArgs& parse_args(InputIterator begin, InputIterator end) {
...
using optparse::OptionArgs;

#endif /* OPTPARSE_H_1356438134_93 */
